...
export function OnboardingClient() {
  ...
  return (
    <main className="min-h-screen overflow-x-hidden bg-[#f7f9fc] text-slate-950">
      ...
      <div className="mx-auto grid max-w-5xl min-w-0 grid-cols-1 gap-8 px-5 py-10 lg:grid-cols-[.85fr_1.15fr] lg:py-20">
        <aside className="min-w-0 lg:pt-9">
          ...
          <p className="mt-9 text-sm font-semibold text-blue-600">
            SECURE SIGN-IN
          </p>
          <h1 className="mt-2 break-words text-3xl leading-tight font-semibold tracking-tight sm:text-4xl">
            Start with proof that it&apos;s you.
          </h1>
          <p className="mt-4 max-w-md break-words leading-7 text-slate-600">
            There are no passwords to remember. We send a one-time sign-in link
            to the email address you control.
          </p>
          <div className="mt-8 space-y-3 text-sm text-slate-600">
            <p className="flex items-center gap-3">
              ...
              Request a secure magic link
            </p>
            <p className="flex items-center gap-3">
              <span className="grid size-7 shrink-0 place-items-center rounded-full bg-slate-200 text-xs font-semibold text-slate-600">
                2
              </span>
            ...
            <p className="flex items-center gap-3">
              ...
              Verify identifiers before scanning
            </p>
          </div>
        </aside>
        <Card className="h-fit w-full min-w-0 self-start border-slate-200 shadow-xl shadow-slate-200/50 lg:mt-24">
          <CardHeader>
            <CardTitle>
              {screen === "sent"
                ? "Check your inbox"
                : "Sign in to Privacy Lens"}
            </CardTitle>
            <CardDescription>
              {screen === "sent"
                ? "Your secure sign-in link is on its way."
                : "Use your email to sign in or create a privacy workspace."}
            </CardDescription>
          </CardHeader>
          <CardContent>
            {screen === "form" && (
              <>
                ...
                <div className="relative mt-2">
                  ...
                  <input
                    ...
                    className="h-11 w-full rounded-lg border border-slate-300 bg-white py-2 pl-10 pr-3 outline-none transition focus:border-blue-500 focus:ring-4 focus:ring-blue-100"
                  />
                </div>
            ...
            {screen === "sending" && (
              <div className="flex min-h-52 flex-col items-center justify-center text-center">
                <span className="size-10 animate-spin rounded-full border-4 border-blue-100 border-t-blue-600" />
                <p className="mt-5 font-medium">Sending your secure link...</p>
            ...
            {screen === "sent" && (
              <div className="text-center">
                <span className="mx-auto grid size-14 place-items-center rounded-full bg-emerald-100">
                  <CheckCircle2 className="size-7 text-emerald-700" />
                </span>
                <p className="mt-5 text-lg font-semibold">Magic link sent</p>
